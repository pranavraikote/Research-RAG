...
def main():
    """Non-agentic RAG CLI entrypoint."""
    ...
    parser.add_argument("-r", "--retrieval", default="semantic",
                        choices=["semantic", "bm25", "hybrid"], help="Retrieval strategy")
    ...
    parser.add_argument("--conference",
                        help='Filter by conference (e.g., "ACL" or "ACL,EMNLP" for multiple)')
    parser.add_argument("--year",
                        help='Filter by year: single (e.g., "2024"), multiple (e.g., "2023,2024"), '
                             'or range (e.g., "2020-2024")')
